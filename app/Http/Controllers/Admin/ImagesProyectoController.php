...
use App\Models\ImagesProyecto;
use Illuminate\Support\Facades\Storage;
use App\Http\Controllers\Controller;

class ImagesProyectoController extends Controller
{
    /**
    ...
    {
        $images = ImagesProyecto::orderBy('created_at', 'DESC')->get();
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('files')) {
            ...
            foreach ($request->file('files') as $file) {
                $rutas= Storage::disk('do')->put('imagenes-proyecto', $file , 'public');
                $pictures[] =$rutas;
                
                // $pictures =Storage::disk('do')->put('file', 'proyectos');
    
            }
            ImagesProyecto::create([
    ...
    {
        $imagen = ImagesProyecto::find($data);
