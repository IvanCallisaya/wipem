<template>
  <div class="container mx-auto bg-white">
    ...
    <h3 class="text-center">Imagenes de la pagina Proyecto</h3>
...
export default {
  ...
  methods: {
    ...
    guardar() {
      ...
      axios
        .post("admin/imagenesProyecto", formData, config)
        .then((response) => {
    ...
    deleteImage(id) {
      axios
        .delete(`admin/imagenesProyecto/${id}`)
        .then((response) => {
          this.getImages();
        })
        .catch((err) => {
